...
public class AlarmsContentHandler {
	...
	public AlarmsContentHandler() {
	}

	public void initHanlder(Context context) {
		context.getContentResolver().registerContentObserver(
				AlarmObject.QAlarmColumns.CONTENT_URI, true,
				new QAlarmContentObserver());
	}
	...
	class QAlarmContentObserver extends ContentObserver {
		...
		public void onChange(boolean selfChange, Uri uri) {
			...
			Log.e(tag, uri.getPath() + "  had changed....");
		}

		@Override
		public void onChange(boolean selfChange) {
			Log.e(tag, "  ---had changed....");
